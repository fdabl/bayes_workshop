...
$$
\begin{align}
P(A \text{ and } B) &= P(A) \times P(B|A) \\[1ex]
...
$$
\begin{align*}
P(B) \times P(A|B) &= P(A) \times P(B|A) \\[1ex]
...
- before that, let's make a short detour on reaction times
...
- analytically, one would "integrate out" $\nu$
...
- a quick note: we can sample randomly from different probability distributions
- R has, for example, "rnorm", "rbeta", "rgamma", "rexp"
