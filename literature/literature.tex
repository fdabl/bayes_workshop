...
\begin{enumerate}[label=-]
    ...
    \item \fullcite{sorensen2015hierarchical}
\end{enumerate}
...
\begin{description}
  ...
  \item \fullcite{lindley2000philosophy}
...
\begin{description}
  \item \fullcite{kruschke2011bayesian}
  \item \fullcite{kruschke2013bayesian}
  \item \fullcite{kruschke2015bayesian}
...
\begin{description}
  ...
  \item \fullcite{schonbrodt2015sequential}
\end{description}
