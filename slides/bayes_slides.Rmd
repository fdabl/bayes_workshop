...
- for example, the variance of the **sampling distribution** of the **sample mean** is $\sigma^2 = \frac{var_{data}}{N}$
...
- that the parameter $\theta$ is assumed fixed
- what is allowed to vary, is the data
...
- draw urn example of @wagenmakers2014power
...
- principle of likelihood: likelihood function contains all information relevant for statistical evidence
...
- it is Fisher's "personal conviction ... that the theory of inverse probability is founded upon an error, and must be wholly rejected"
