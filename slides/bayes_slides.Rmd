...
Ugly                       Pretty
Irrelevant                 Relevant
what's tought              what's not tought
...
- they **did not** distinguish between Fisher's and Neyman-Pearson's approach (they **hated** each other!)
- Null Hypothesis Significance Testing is a hybrid between those two **incompatible** paradigms
...
- did Skinner? what's with Köhler? Pavlov? [@gigerener1993superego]
...
- 2a) Use 0.05 as a convention for rejecting the null
- always use this procedure [@gigerenzer20014mindless]
...
## how often do people get that wrong?
...
- look at data, run test, gather more data, run test, etc.
...
- high power **does not** imply **diagnostic** data!
